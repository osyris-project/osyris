...
# Density vs T
if(len(fname) > 0):
    osiris.plot_histogram(mydata.log_rho,mydata.log_B,fname=fname,scalar_args={"cmap":"osiris_r,log"},outline=True)
else:
    osiris.plot_histogram(mydata.log_rho,mydata.log_B,block=True,scalar_args={"cmap":"osiris_r,log"},outline=True)
